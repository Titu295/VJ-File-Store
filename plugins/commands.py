...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('🕊️ ᴡᴀᴛᴄʜ ᴍᴏᴠɪᴇ ᴏɴʟɪɴᴇ ', url='https://titu-movie.blogspot.com/')
            ],[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/+zRkE-xV94so4MmY1'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/Titu_Movie')
            ],[
